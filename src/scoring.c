...
ScoringStatus calculate_and_distribute_pot_for_completed_board(
    uint64_t board_id, GameResult result) {
  ...
  return calculate_and_distribute_pot_for_moves_internal(
      board_id, &board_stub, mres.rows, mres.count);
}
